...
class SuperTooltip {
  ...
  //
  /// [customShadow] defines if the tooltip should have a shadow
  ...
  ///
  /// Apply a [customOffset] offset to the tooltip, (ie: ovoid tooltip to display over an important widget information by translating in Y axis)
  ...
  void show(BuildContext targetContext) {
    ...
    _targetCenter = renderBox.localToGlobal(
      ...
      ancestor: overlay,
    ).translate(customOffset != null? customOffset.dx : 0, customOffset != null? customOffset.dy : 0);
